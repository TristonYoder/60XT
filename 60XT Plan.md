# Body Transformation Challenge — Triston's Plan
**Start:** March 31, 2026 | **Review:** Weekly (Friday) | **Version:** 1.1
...
| ------------------------- | ------------------------- |
| Height                    | 6'2"                      |
| Challenge Start Weight    | 205.6 lbs                 |
| Challenge Start Body Fat  | 18.2% / 37.4 lbs fat mass |
| Lean Body Mass            | 168.4 lbs                 |
| BMR                       | ~1,993 kcal               |
...
1. **Primary:** Maximum fat loss while preserving lean mass
	1. Target: 14% Body Fat
2. **Secondary:** Opportunistic muscle retention / hypertrophy
	1. Target: +2 lbs of Muscle Mass
...
| ------- | ------------ | ---------------------------------- |
| v1.0    | Mar 31, 2026 | Initial plan. Baseline biometrics. |
